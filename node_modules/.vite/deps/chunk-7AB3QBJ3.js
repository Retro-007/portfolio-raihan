...
var PrimeReact$1 = _createClass2(function PrimeReact2() {
...
var Ripple = React4.memo(React4.forwardRef(function() {
  ...
  return context && context.ripple || PrimeReact.ripple ? React4.createElement("span", {
    role: "presentation",
    ref: inkRef,
    className: "p-ink",
    onAnimationEnd
...
var Portal = React5.memo(function(inProps) {
  ...
  var _React$useState = React5.useState(props.visible && DomHandler.hasDOM()), _React$useState2 = _slicedToArray2(_React$useState, 2), mountedState = _React$useState2[0], setMountedState = _React$useState2[1];
  useMountEffect(function() {
...
//# sourceMappingURL=chunk-7AB3QBJ3.js.map
