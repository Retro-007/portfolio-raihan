...
var ObjectUtils2 = function() {
  ...
  _createClass(ObjectUtils4, null, [{
    ...
    value: function resolveFieldData(data, field) {
      if (data && Object.keys(data).length && field) {
        if (this.isFunction(field)) {
          return field(data);
        } else if (ObjectUtils4.isNotEmpty(data[field])) {
          return data[field];
    ...
    value: function sort(value1, value2) {
      ...
      var result = ObjectUtils4.compare(value1, value2, locale, order);
      var finalSortOrder = order;
      if (ObjectUtils4.isEmpty(value1) || ObjectUtils4.isEmpty(value2)) {
    ...
    value: function compare(value1, value2, locale) {
      ...
      var result = -1;
      var emptyValue1 = ObjectUtils4.isEmpty(value1);
      var emptyValue2 = ObjectUtils4.isEmpty(value2);
